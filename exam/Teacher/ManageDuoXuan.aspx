<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageDuoXuan.aspx.cs" Inherits="Admin1_Default" %>
          ...
          <asp:GridView ID="gvQueInfo" runat="server" AutoGenerateColumns="False" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField HeaderText="编辑" Text="编辑" DataNavigateUrlFields="ID" 
                      DataNavigateUrlFormatString="ChangeDuoXuan.aspx?ID={0}" >
                  <ItemStyle Width="100px" />
                  </asp:HyperLinkField>
