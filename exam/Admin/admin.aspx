<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="Admin1_Default" %>
...
<body>
    ...
    <div class="middle">
      <div class="middle_left">
       <ul id="nav">
          <li><a href="#Menu=ChildMenu1"  onclick="DoMenu('ChildMenu1')">管理员</a>
            <ul id="ChildMenu1" >
             <li><a href="ManageAdmin.aspx" target="mainFrame">管理员信息</a></li>
             <li><a href="AddAdmin.aspx" target="mainFrame">管理员录入</a></li>       
            </ul>
          </li>
        <li><a href="#Menu=ChildMenu2" onclick="DoMenu('ChildMenu2')">学生管理</a>
          <ul id="ChildMenu2">
            <li><a href="ManageStudent.aspx" target="mainFrame">查看学生信息</a></li>
            <li><a href="AddStudent.aspx"  target="mainFrame">增加学生</a></li>       
           </ul>
       </li>
       <li><a href="#Menu=ChildMenu3" onclick="DoMenu('ChildMenu3')">教师管理</a>
          <ul id="ChildMenu3" class="collapsed">
            <li><a href="AddTeacher.aspx" target="mainFrame">添加教师</a></li>
            <li><a href="ManageTeacher.aspx"  target="mainFrame">管理教师</a></li>       
           </ul>
       </li>
      </ul>
     </div>
