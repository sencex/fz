<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTeacher.aspx.cs" Inherits="Admin_Default" %>
...
<link href="../css/Common.css" rel="stylesheet" type="text/css" />
     ...
     <style type="text/css">
     .c_1{width:400px;margin:0px auto;height:150px;}
     ...
     <script type="text/javascript" language="javascript">
              function CustomValidator(source, arguments) {
                  if (arguments.Value > 9 && arguments.Value < 99)
        ...
        <li>
            ...
            <div class="c_1_y">
                <asp:CustomValidator ID="CustomValidator1" runat="server" 
                    ErrorMessage="*请输入2位数字" ClientValidationFunction="CustomValidator" 
        ...
        <li>
            ...
            <div class="c_1_y">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ErrorMessage="*必填" ControlToValidate="TextBox2"></asp:RequiredFieldValidator>
            </div>
            </li>
        <li>
            ...
            <div class="c_1_y">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ErrorMessage="*必填" ControlToValidate="TextBox3"></asp:RequiredFieldValidator>
            </div>
            </li>
             <li>
                 <div class="c_1_left"><asp:Label ID="Label4" runat="server" Text="职    称"></asp:Label></div>
                 <div class="c_1_right">
                 <asp:DropDownList ID="DropDownList1" runat="server" Width="150px">
                     <asp:ListItem Value="1">教授</asp:ListItem>
