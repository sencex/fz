<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="getpwd3.aspx.cs" Inherits="User_Default4" %>
...
<div id="content">
 ...
 <div class="ct_notice">找回密码成功</div>
 <div class="ct_ct"><div class="ct_left">学号：</div><div class="ct_right">
     <asp:Label ID="Label1" runat="server" ForeColor="#0066FF" Text="Label"></asp:Label>
     </div>
 </div>
 <div class="ct_ct"><div class="ct_left">密码：</div><div class="ct_right">
     <asp:Label ID="Label2" runat="server" ForeColor="#0066FF" Text="Label"></asp:Label>
     </div>
 </div>
 <div class="btn">
